...
export default function ChatInfoContactItem({
  type,
  itemValue,
  setInputValue,
}) {
  ...
  return (
    <div className="contact-item d-flex justify-content-between align-items-center mb-1">
      ...
      <div className="item-right d-flex">
        ...
        {itemReadOnly ? (
          <div className="d-flex gap-1">
            <Button variant="action" onClick={handleCopyInput}>
              <MdOutlineContentCopy size={12} />
            </Button>
            <Button variant="action" onClick={() => setItemReadOnly(false)}>
